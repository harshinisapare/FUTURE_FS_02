  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        'section': ['1.125rem', { lineHeight: '1.5rem', letterSpacing: '-0.02em' }],
        'kpi': ['2rem', { lineHeight: '2.25rem', letterSpacing: '-0.03em' }],
      },
      colors: {
      ...
      animation: {
        ...
        "number-flip": "number-flip 400ms cubic-bezier(0.16, 1, 0.3, 1)",
      },
    },
  },
